...
5. Open OpenRefine in another tab/window; load `languages-ds-authority.csv` ([FILE][language_authority]) into this new OpenRefine tab; delete any previously loaded versions of the file in OpenRefine (Menu option: `Open project` and browse project list)
