...
4. Open OpenRefine in another tab/window; load `materials-ds-authority.csv` ([FILE][material_authority]) into this new OpenRefine tab; delete any previously loaded versions of the authority file in OpenRefine (Menu option: `Open project` and browse project list, select X and confirm)
