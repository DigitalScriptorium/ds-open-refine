...
9. Add `organization-qid`, `instance-of-organization`, `organization-name` columns; consolidate `structured_value` and `instance_of` columns; finalize workflow: [JSON][name_finalize]
