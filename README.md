...
7. Add `organization-qid` and `instance-of-organization` columns; consolidate `name_qid` and `name_instance_of` columns; add `name_reconciled` column: [JSON][name_finalize]
